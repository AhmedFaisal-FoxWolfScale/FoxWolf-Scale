# FoxWolf Scale for Social Engineering Skills Assessment
...
### العربية
1. **اضغط** على أيقونة "إضافة من GitHub" (+) قبل بدء المحادثة مع Claude AI.
2. **سجّل** الدخول إلى حسابك على GitHub.
3. **ألصق** هذا الرابط 'https://github.com/AhmedFaisal-FoxWolfScale/FoxWolf-Scale.git' في حقل الرابط.
4. **اختر** الملف Claude-Operational-Guide.md من القائمة واضغط على "إضافة".
5. **اطلب** : "أرغب في تقييم مهاراتي باستخدام مقياس FoxWolf".
...
**كلود يقبل النصوص فقط وليس الصور:**
- قم بتحويل المحادثات إلى نص قبل إرسالها لكلود
- لا ترسل لقطات شاشة (screenshots) للمحادثات
- استخدم أدوات OCR أو النسخ اليدوي لاستخراج النص
- تأكد من نسخ المحادثة كاملة بما في ذلك الطوابع الزمنية

**أدوات مفيدة لتحويل الصور إلى نص:**
- Google Lens
- OnlineOCR.net
- Microsoft Office Lens
- CamScanner
...
#### 🦊 صفات الثعلب (المهارات التكتيكية)
